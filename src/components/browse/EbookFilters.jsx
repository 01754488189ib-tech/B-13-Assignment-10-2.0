        ...
        <div className="md:col-span-2 flex flex-col gap-2">
          ...
          <div className="relative">
            <select
              ...
              className="w-full bg-[#0b0b0f] border border-white/5 text-zinc-300 rounded-xl h-11 px-3 text-sm outline-none appearance-none cursor-pointer focus:border-amber-500/50 transition"
            >
              {genres.map((g) => (
